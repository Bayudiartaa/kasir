      ...
      <div class="box">
        <div class="box-header">
          <form  action="<?php echo base_url().'admin/menu/cetak_menu'?>" method="post" enctype="multipart/form-data" target="_blank">
            <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>&nbsp; Add Menu</a> 

            <!-- Cetak Data -->
            <button type="submit" class="btn btn-success btn-sm" id="simpan"><i class="glyphicon glyphicon-print"></i>&nbsp; Cetak Data</button>
          </form> 
        </div>
      ...
      <form class="form-horizontal" action="<?= base_url().'admin/menu/simpan_menu'?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group form-group-sm batas_bawah">
            ...
            <div class="col-sm-7">
              <input type="text" name="kode_menu" class="form-control form-control-sm" id="kode_menu" placeholder="Input Kode Menu Harus 5 Character" required autocomplete="off" maxlength="5">
            </div>
          </div>
