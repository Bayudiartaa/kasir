    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <?php
          if ($akses == 3) { ?>
            <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal" id="addTransaksi"><i class="fa fa-plus"></i>&nbsp; Add Transaksi</a>
          <?php
          } else { ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="input-group">
                      ...
                      <button type="submit" class="btn btn-success cetakLaporan"><i class="glyphicon glyphicon-print"></i>&nbsp; Cetak Data</button>
                    </div>
                  </div>
                </div>
              </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 bg-black" style="width: 30%; margin-left:10px;">
            <form class="form-horizontal" method="post" id="transaksiMenu">
              <div class="modal-body">
                ...
                <div class="form-group form-group-sm batas_bawah">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="qty" class="form-control form-control-sm text-right angkaSemua" placeholder="Qty" required autocomplete="off" onBlur="checkQuantity()">
                  </div>
                ...
                <div class="form-group form-group-sm batas_bawah">
                  ...
                  <div class="col-sm-8">
                    <select name="condition" class="form-control chosen-select" id="condition">
                  ...
                  <form action="<?= base_url() . 'admin/transaksi/simpan_transaksi_bayar' ?>" method="POST" target="_blank">
                    ...
                    <tr>
                      ...
                      <td rowspan="3" style="border:0px; ">
                        <button type="submit" class="btn btn-lg btn-success cekBayar"><i class="fa fa-money fa-2x"></i></button>
                      </td>
                    </tr>
...
<script>
  ...
  function checkQuantity() {
    $.ajax({
      ...
      data: {
        qty: $("#qty").val(),
        // buku: document.getElementById('buku').textContent
      },
