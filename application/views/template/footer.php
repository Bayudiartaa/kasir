  ...
  <script>
    ...
    $(document).on('click', '#transaksiSimpan', function() {
      ...
      if (idQty == "") {
        swal("Error!", "Qty Belum diisi!", "error");
    ...
    $(document).on('click', '.lapCari', function() {
      ...
      $.ajax({
        ...
        cache: false,
        success: function() {
          $('#transPeriode').load('<?= base_url(); ?>/admin/laporan/laporan_details', {
            tglDari: tglDari,
            tglSampai: tglSampai,
            pengguna_id: pengguna_id
          });
    ...
    $(document).on('click', '.lapCariTransaksi', function() {
      ...
      $.ajax({
        ...
        cache: false,
        success: function() {
          $('#allTransaksi').load('<?= base_url(); ?>/admin/transaksi/laporan_transaksi_details', {
            tglDari: tglDari,
            tglSampai: tglSampai,
            pengguna_id: pengguna_id
          });
